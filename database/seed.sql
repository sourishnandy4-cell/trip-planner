...
INSERT INTO expense_splits (expense_id, user_id, owed_amount, is_settled)
VALUES
    (expense_1_id, demo_user_1, 400.00, TRUE),
    (expense_1_id, demo_user_2, 400.00, FALSE),
    (expense_1_id, demo_user_3, 400.00, FALSE);
...
INSERT INTO expense_splits (expense_id, user_id, owed_amount, is_settled)
VALUES
    (expense_2_id, demo_user_1, 30.00, TRUE),
    (expense_2_id, demo_user_2, 30.00, TRUE),
    (expense_2_id, demo_user_3, 30.00, FALSE);
...
INSERT INTO expense_splits (expense_id, user_id, owed_amount, is_settled)
VALUES
    (expense_3_id, demo_user_1, 60.00, FALSE),
    (expense_3_id, demo_user_2, 60.00, FALSE),
    (expense_3_id, demo_user_3, 60.00, TRUE);
...
INSERT INTO expense_splits (expense_id, user_id, owed_amount, is_settled)
VALUES
    (expense_4_id, demo_user_1, 15.00, TRUE),
    (expense_4_id, demo_user_2, 15.00, TRUE),
    (expense_4_id, demo_user_3, 15.00, FALSE);
